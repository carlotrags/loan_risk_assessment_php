...
<script>
    ...
    if (dropdownBtn && dropdownMenu) {
        dropdownBtn.addEventListener('click', function (event) {
            ...
            if (mainNavbar.classList.contains('active')) {
                ...
                burgerToggle.querySelector('i').classList.remove('fa-xmark');
                burgerToggle.querySelector('i').classList.add('fa-bars');
            }
    ...
    document.addEventListener('click', function (event) {
        ...
        if (mainNavbar && !burgerToggle.contains(event.target) && !mainNavbar.contains(event.target)) {
            mainNavbar.classList.remove('active');
